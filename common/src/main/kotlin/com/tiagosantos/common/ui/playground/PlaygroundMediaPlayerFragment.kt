...
class PlaygroundMediaPlayerFragment(ttsSettings: TTSFragmentSettings) :
    ...
    private val medViewModel: PlaygroundViewModel by viewModels()
    private val player = ExoPlayer.Builder(requireContext()).build()

    companion object {
        fun newInstance() = PlaygroundMediaPlayerFragment()
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button_return_meditation.setOnClickListener {
            val fragment: Fragment = PlaygroundFragment()
